...
st.markdown("<h1 style='text-align: center;'>Las Pythonventuras</h1>", unsafe_allow_html=True)
...
col1.image("IMG_8140.png", caption='yo', width=300)
...
texto = """
HOLA soy Ainhoa Garatea, tengo 20 años y soy de LIMA-PE. Soy hija unica y vivo con mis papas y dos gatas de 12 años en Miraflores. Estudie en el colegio Pestalozzi, donde aprendi a hablar ALEMAN e INGLES. Ahora estudio Comunica Audiovisual en la PUCP. Hevivido toda mi vida en esta cuidad y en un futuro me gustaria vivir en Europa, en Alemania o España y trabajar como Fotografa.  
"""
...
texto_2 = """
Mi experiencia con este curso y con python no fueron gratas. Se me hizo muy complicado de entender y sobretodo cumplir con las exigencias en tan corto tiempo. Fue muy dificil para mi , pues yo no tenía ningun conocimiento con python ni programar y el curso exigia por lo menos entender algo, pues sino era una tortura. La verdad que espero que me sirva de algo en el futuro y para mi carrera. 
"""
...
sidebar.markdown("<h1 style='text-align: center;'>GRAFICOS DEL CICLO</h1>", unsafe_allow_html=True)
...
graficos = ['Gráfico de goles del equipo roma', 'Gráfico de Pastel ATALANTA', 'tarjetas amarillas por equipo local']
